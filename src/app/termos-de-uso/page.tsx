      ...
      <main className="flex-1 py-12 sm:py-20">
        <div className="container max-w-4xl">
          ...
          <div className="prose dark:prose-invert max-w-none text-muted-foreground space-y-4">
            <h2 className="text-xl font-semibold text-foreground">1. Termos</h2>
            <p>
              Ao acessar ao site <a href="/">LivrosMaisCobiçados</a>, concorda em
              ...
              contidos neste site são protegidos pelas leis de direitos autorais
              e marcas comerciais aplicáveis.
            </p>
            <h2 className="text-xl font-semibold text-foreground">2. Uso de Licença</h2>
            <p>
              É concedida permissão para baixar temporariamente uma cópia dos
              materiais (informações ou software) no site LivrosMaisCobiçados,
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                ...
                software contido no site LivrosMaisCobiçados;
              </li>
              <li>
            ...
            <p>
              ...
              dessas restrições e poderá ser rescindida por LivrosMaisCobiçados
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                Os materiais no site da LivrosMaisCobiçados são fornecidos 'como
                estão'. LivrosMaisCobiçados não oferece garantias, expressas ou
              ...
              <li>
                Além disso, o LivrosMaisCobiçados não garante ou faz qualquer
            ...
            <h2 className="text-xl font-semibold text-foreground">4. Limitações</h2>
            <p>
              Em nenhum caso o LivrosMaisCobiçados или seus fornecedores serão
              ...
              LivrosMaisCobiçados, mesmo que LivrosMaisCobiçados ou um
              representante autorizado da LivrosMaisCobiçados tenha sido
              notificado oralmente ou por escrito da possibilidade de tais danos.
              Como algumas jurisdições не permitem limitações em garantias
              implícitas, ou limitações de responsabilidade por danos
              consequentes ou incidentais, essas limitações podem não se aplicar
              a você.
            </p>
            <h2 className="text-xl font-semibold text-foreground">5. Precisão dos materiais</h2>
            <p>
              Os materiais exibidos no site da LivrosMaisCobiçados podem incluir
              erros técnicos, tipográficos ou fotográficos. LivrosMaisCobiçados
              não garante que qualquer material em seu site seja preciso,
              completo ou atual. LivrosMaisCobiçados pode fazer alterações nos
              materiais contidos em seu site a qualquer momento, sem aviso prévio.
              No entanto, LivrosMaisCobiçados não se compromete a atualizar os
              materiais.
            </p>
            <h2 className="text-xl font-semibold text-foreground">6. Links</h2>
            <p>
              O LivrosMaisCobiçados não analisou todos os sites vinculados ao seu
              site e não é responsável pelo conteúdo de nenhum site vinculado. A
              inclusão de qualquer link não implica endosso por LivrosMaisCobiçados
              do site. O uso de qualquer site vinculado é por conta e risco do
              usuário.
            </p>
            <h3 className="text-lg font-semibold text-foreground">Modificações</h3>
            <p>
              O LivrosMaisCobiçados pode revisar estes termos de serviço do site
            ...
            <h3 className="text-lg font-semibold text-foreground">Lei aplicável</h3>
            <p>
              Estes termos e condições são regidos e interpretados de acordo com
              as leis do LivrosMaisCobiçados e você se submete irrevogavelmente
