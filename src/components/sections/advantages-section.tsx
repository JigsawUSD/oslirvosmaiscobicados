    ...
    <section id="advantages" className="py-12 sm:py-20 bg-white dark:bg-card">
      <div className="container">
        <div className="max-w-3xl mx-auto text-lg text-center text-muted-foreground space-y-6 mb-12">
          ...
          <p>
            Dentro do conjunto, você terá acesso aos livros mais cobiçados de finanças, reunidos em um só lugar para ajudar você a aprender sobre dinheiro, investimentos e construção de riqueza no seu próprio ritmo.
          </p>
        </div>
