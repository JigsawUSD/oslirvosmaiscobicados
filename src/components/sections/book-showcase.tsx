      ...
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-primary tracking-tight">
            Conheça os 10 Livros Que Irão Alavancar Sua Vida
          </h2>
          <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
            De clássicos atemporais a best-sellers modernos, este pacote foi cuidadosamente selecionado para o seu sucesso.
          </p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8">
          {books.map((book) => (
            <div key={book.id} className="group flex flex-col items-center text-center">
              ...
              <h3 className="mt-4 font-bold text-md leading-tight">{book.title}</h3>
