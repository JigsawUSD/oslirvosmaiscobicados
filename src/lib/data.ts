...
export const books: Book[] = [
  ...
  },
  {
    ...
    description: 'Princípios atemporais sobre economia pessoal e planejamento financeiro através de parábolas da antiga Babilônia.',
    image: findImage('book-richest-man'),
  },
  {
    id: '12',
    title: 'As Armas da Persuasão',
    author: 'Robert B. Cialdini',
    description: 'Explore os seis princípios psicológicos que direcionam o comportamento humano e aprenda a usá-los de forma ética.',
    image: findImage('book-influence'),
  },
  {
    id: '8',
  ...
  },
  {
    ...
    author: 'Eric Ries',
    description: 'Como os empreendedores de hoje utilizam a inovação contínua para criar empresas extremamente bem-sucedidas.',
    image: findImage('book-lean-startup'),
  },
  {
    id: '14',
    title: 'Do Mil ao Milhão',
    author: 'Thiago Nigro',
    description: 'Sem cortar o cafezinho, os três pilares para construir sua independência financeira: gastar bem, investir melhor e ganhar mais.',
    image: findImage('book-do-mil-ao-milhao'),
  },
  {
    id: '15',
    title: 'Essencialismo',
    author: 'Greg McKeown',
    description: 'A disciplinada busca por menos. O guia para identificar o que é absolutamente essencial, e eliminar todo o resto.',
    image: findImage('book-essentialism'),
  },
];
